...
io.sockets.on('connection', function(socket) {
	...
	socket.on('create', function() {
		mySqlConnection.query("create table if not exists user_auth (user_id TEXT not null primary key, user_pw TEXT, user_mail TEXT, user_name TEXT, user_birth INT);", function(err, result) {
			if (err) {
